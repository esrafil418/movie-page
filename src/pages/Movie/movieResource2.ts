// movieResource2.ts was duplicated and caused TypeScript duplicate identifier errors
// This file is intentionally left as a no-op to avoid build-time collisions.
